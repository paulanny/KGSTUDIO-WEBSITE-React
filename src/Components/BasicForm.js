...
const BasicForm = (props) => {
  ...
  return (
    <form onSubmit={submitHandler}>
      ...
      <h2 className='modalh2'>Book a <span className='coloredtxt'>Design</span></h2>
      <p className='modalp'>Fill the form below to book a design with us at KGStudio</p>
      </div>
...
<div className={lastNameClasses}>
  ...
  {lastNameHasError && <p className="error-text">Please enter a last name.</p>}
      ...
      <button className='formbtn'>Cancel</button>
        <button className='formbtn' disabled={!formIsValid}>Book Design</button>
      </div>
    </form>
  );
};
